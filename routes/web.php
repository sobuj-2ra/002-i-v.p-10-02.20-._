...
//    entry type
    ...
    Route::get('operation/counter_call_get_data2', 'CounterController@getData');
...
///--------->> SETTING ////
  // center setup //
  Route::get('/setting/action-setup/create', 'ManageSettingController@actionSetupCreate');
  Route::post('/setting/action-setup/create', 'ManageSettingController@actionSetupUpdate');
  Route::get('/setting/queue-setup/create', 'ManageSettingController@queueSetupCreate');
  Route::post('/setting/queue-setup/create', 'ManageSettingController@queueSetupStore');
  Route::get('/setting/queue-setup/edit/{id}', 'ManageSettingController@queueSetupEdit');
  Route::post('/setting/queue-setup/update', 'ManageSettingController@queueSetupUpdate');
  Route::get('/setting/queue-setup/destroy/{id}', 'ManageSettingController@queueSetupDestroy');
 
  // counter setup //
  Route::get('/setting/counter-setup/create', 'ManageSettingController@counterSetupCreate');
  Route::post('setting/counter-setup/create', 'ManageSettingController@counterSetupStore');
...
Route::post('counter-receive/user-wise/summary/report','CounterController@CounterUserWiseSumaryReportView');


//// ADMIN OPERATION /////
Route::get('operation/manage-queue','ManageSettingController@manageQueue');
Route::get('manage_queue_pending_token_axios','ManageSettingController@deletePendingToken');
Route::get('manage_queue_history_token_axios','ManageSettingController@deleteHistoryToken');
Route::get('manage_queue_issue_token_axios','ManageSettingController@SetIssueToken');
Route::get('manage_queue_create_token_axios','ManageSettingController@CreateTokenNumber');


Route::get('operation/queue-status','ManageSettingController@queueStatus');
Route::get('operation/change-status','ManageSettingController@changeStatus');
Route::post('operation/change-status/edit','ManageSettingController@changeStatusEdit');
Route::post('operation/change-status/update','ManageSettingController@changeStatusUpdate');
Route::get('operation/present_status_getdata','ManageSettingController@changeDataGet');
Route::get('operation/search_token_info','ManageSettingController@searchTokenInfo');
Route::get('operation/sync-maintenance','ManageSettingController@SyncMaintenanceView');
Route::post('operation/sync-maintenance','ManageSettingController@SyncMaintenanceGet');
Route::post('operation/sync-maintenance-update','ManageSettingController@SyncMaintenanceGetUpdate');

// VISA REQUIREMENT //
Route::get('/operation/visa-requirement', 'ManageSettingController@visaRequireCreate');
Route::post('/operation/visa-requirement', 'ManageSettingController@visaRequireStore');
Route::get('/operation/visa-requirement/edit/{id}', 'ManageSettingController@visaRequireEdit');
Route::post('/operation/visa-requirement/update', 'ManageSettingController@visaRequireUpdate');
Route::get('/operation/visa-requirement/destroy/{id}', 'ManageSettingController@visaRequireDestroy');


// CORRECTION FEE //
Route::get('/operation/correction-fee', 'ManageSettingController@corFeeCreate');
Route::post('/operation/correction-fee', 'ManageSettingController@corFeeStore');
Route::get('/operation/correction-fee/edit/{id}', 'ManageSettingController@corFeeEdit');
Route::post('/operation/correction-fee/update', 'ManageSettingController@corFeeUpdate');
Route::get('/operation/correction-fee/destroy/{id}', 'ManageSettingController@corFeeDestroy');

// PORT NAME //
Route::get('/operation/port-name', 'ManageSettingController@portNameCreate');
Route::post('/operation/port-name', 'ManageSettingController@portNameStore');
Route::get('/operation/port-name/edit/{id}', 'ManageSettingController@portNameEdit');
Route::post('/operation/port-name/update', 'ManageSettingController@portNameUpdate');
Route::get('/operation/port-name/destroy/{id}', 'ManageSettingController@portNameDestroy');

// REJECTION REASON //
Route::get('/operation/rejection-reason', 'ManageSettingController@rejectReasonCreate');
Route::post('/operation/rejection-reason', 'ManageSettingController@rejectReasonStore');
Route::get('/operation/rejection-reason/edit/{id}', 'ManageSettingController@rejectReasonEdit');
Route::post('/operation/rejection-reason/update', 'ManageSettingController@rejectReasonUpdate');
Route::get('/operation/rejection-reason/destroy/{id}', 'ManageSettingController@rejectReasonDestroy');
