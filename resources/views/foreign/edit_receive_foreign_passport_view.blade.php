                                    ...
                                    <div  v-for="(mainitem, i) in addMoreButtonArr" class="col-md-12">
                                        <div  class="webfile-bottom-area">
                                            <div class="webfile-success-area">
                                                <form id="update-foreign-form" action="{{URL::to('update-foreign-passport')}}" method="POST">
                                                    {{csrf_field()}}
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <select name="sticker_type" id="sticker_type" class="input_values form-control" style="" required>
                                                                    <option value=""> </option>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <input @keyup="SpecialCharValidationFunc" @blur="checkValidStkrUpdateFunc" type="number" name="validStkr" :id="'validStkr'+i" :data-id="i" value={{$appServed->RoundSticker}} class="form-control input_values doubleStkr" placeholder="Sticker No." required  autocomplete="off">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control input_values" :id="'name'+i" :data-id="i" name="name" value="{{$fpServed->app_name}}"  autocomplete="off" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="">Contact</label>
                                                                <input class="form-control input_values" name="contact" :id="'contact'+i" :data-id="i" value="{{$fpServed->contact}}" pattern=".{10}" title="Minimum  & Maximum 10 digit" 
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control input_values" name="nationality" value="{{$fpServed->nationality}}" :id="'nationality'+i" :data-id="i"  autocomplete="off" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="">Visa Type &nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                                <label for=""><span :id="'tddDelDateId'+i"  style="height:10px;display: inline-block;">( {{$fpServed->tdd }} )</span></label>
                                                                <input name="tddDelDateValue" :id="'tddDelDateValue'+i" value="{{$fpServed->tdd}}" type="hidden" class="input_values">
                                                                {{-- @{{i}} --}}
                                                                <select class="form-control input_values visa_type_value" @change="visaTypeOnChange" name="visa_type" :id="'visa_type'+i" :data-id="i" required>
                                                                    ...
                                                                    @foreach ($visa_type as $item)
                                                                        @if($fpServed->visa_type ==  $item->visa_type)
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control input_values" name="duration" :id="'duration'+i" :data-id="i" required>
                                                                    ...
                                                                    @foreach ($duration as $item)
                                                                        <?php
                                                                            $dur = '';
                                                                            $reArr = explode('/',$fpServed->remarks);
                                                                            if(count($reArr) > 0){
                                                                               $dur =  $reArr[0];
                                                                            }
                                                                        ?>
                                                                        @if($dur == $item->duration)
                                                                            <option value="<?php  echo $item->duration; ?>" selected><?php  echo $item->duration; ?></option>
                                                                        @else
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control input_values" name="entry_type" :id="'entry_type'+i" :data-id="i" required>
                                                                    ...
                                                                    ?>
                                                                    @if($enType == $item->entry_type)
                                                                        <option value="<?php  echo $item->entry_type; ?>" selected><?php  echo $item->entry_type; ?></option>
                                                                    @else
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="">Date Of Checking</label>
                                                                <input class="form-control input_values datepicker" value="{{Date('d-m-Y', strtotime($fpServed->date_of_checking))}}" name="date_of_checking" :id="'check_date'+i" :data-id="i" placeholder="Date of Checking" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div id="show">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <input @keyup="TotalFeeFunc"   type="text" class="form-control input_values" :id="'visaFee'+i" :data-id="i" value="{{$fpServed->visa_fee}}" placeholder="Visa Fee" disabled autocomplete="off">
                                                                <input  type="hidden" class="form-control input_values" name="visa_fee" :id="'visaFee'+i" :data-id="i" value="{{$fpServed->visa_fee}}">
                                                            ...
                                                            <div class="col-md-4">
                                                                <label for="">Fax Trans Charge</label>
                                                                <div class="input-group">
                                                                    <input @keyup="TotalFeeFunc"   class="form-control input_values" :id="'faxCharge'+i" value="{{$fpServed->fax_trans_charge}}"  :data-id="i" placeholder="Fax Trans. Charge" disabled>
                                                                    <input type="hidden" name="fax_trans_charge" :id="'faxCharge'+i" value="{{$fpServed->fax_trans_charge}}"  :data-id="i">
                                                                    <span class="input-group-addon">Taka</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="">ICWF</label>
                                                                <div class="input-group">
                                                                    <input @keyup="TotalFeeFunc"  class="form-control input_values"  :id="'icwf'+i" value="{{$fpServed->icwf}}" :data-id="i" placeholder="ICWF" disabled>
                                                                    <input type="hidden"  class="form-control input_values" name="icwf" :id="'icwf'+i" value="{{$fpServed->icwf}}" :data-id="i" >
                                                                    <span class="input-group-addon">Taka</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-md-8">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label for="">Visa App Charge</label>
                                                                    <div class="input-group">
                                                                        <input @keyup="TotalFeeFunc" class="form-control input_values"  value="{{$fpServed->visa_app_charge}}" :id="'appCharge'+i" :data-id="i" placeholder="Visa App. Charge" disabled>
                                                                        <input type="hidden" name="visa_app_charge"  value="{{$fpServed->visa_app_charge}}" >
                                                                        <span class="input-group-addon">Taka</span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        <label for="Old Passport Qty">Old Passport Qty</label>
                                                                        <input @keyup="oldPassQtyFunc" required class="form-control input_values" name="old_pass" :id="'old_pass'+i" :data-id="i" value="{{$fpServed->old_passport_qty}}" placeholder="Old Passport Qty">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input :id="'sp_fee'+i" :data-id="i"  class="form-control input_values" type="text" value="{{$appServed->proc_fee}}"  disabled>
                                                                        <input  name="sp_fee" class="form-control input_values" type="hidden" value="{{$appServed->proc_fee}}"  disabled>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
