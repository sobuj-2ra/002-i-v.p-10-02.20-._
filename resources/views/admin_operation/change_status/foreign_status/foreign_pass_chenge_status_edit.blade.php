...
<!--Page Title-->
@section('page-title')
<span style="color:#1a8e46">Foreign Passport Edit</span>
@endsection
                      ...
                      <div class="main_part gray-back" >
                        <div class="row">
                          ...
                          <div class="col-md-8 col-md-offset-2">
                              ...
                              <!-- Modal -->
                              <form method="POST" autocomplete="off" action="{{URL::to('operation/change-status/foreign/update')}}">
                              <div class="panel panel-info">
                                  {{csrf_field()}}
                                <div class="panel-heading ">
                                  <span class="modal-title" id="exampleModalLabel"></span>
                                </div>
                                <div class="panel-body" style="background:#c9c9c9;">
                                  <p class="form_title_center"  style="color: #1a8e46">
                                  <b >-CHANGE STATUS-</b>
                                </p>
                                ...
                                <div class="panel-footer" style="background:#c9c9c9;">
                                  <a href="{{URL::to('/operation/change-status/foreign')}}" class="btn btn-default">Back</a>&nbsp;&nbsp;&nbsp;
                                  <button style="background:#1a8e46;border:1px solid #1a8e46" type="submit" id="submit" class="btn btn-primary">Update</button>
                                </div>
                              </div>
                            </form>
                          </div>
